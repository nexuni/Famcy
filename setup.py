...
setuptools.setup(
    ...
    package_data=package_data_with_recursive_dirs({"Famcy":["bower_components", "node_modules", "templates", "static", "scripts", "famcy.ini", "gunicorn.conf.py", "_style_", "_responses_", "_items_", "_elements_"]}),
